...
//        /// if the dropdown doesnot have the select tagname then we can handel byt the List of WebElemnt
//        WebElement kh =driver.findElement(By.xpath("//select[@id='dropdown-class-example']"));
//        kh.click();
//       String seleValue="Option1";
//        List<WebElement> optionslist =driver.findElements(By.xpath("//select[@id='dropdown-class-example']/option"));
//        for(int x=1; x<optionslist.size();x++){
//            if(optionslist.get(x).getText().contains(seleValue)){
//                optionslist.get(x).click();
//                break;
//            }
//
//        }
